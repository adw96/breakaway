...
Let's quickly peruse the covariate information. 
...
## Creating frequency tables
We're now going to "collapse" the data's columns (samples) into frequency tables. We use several functions here: table, apply, as.data.frame and lapply.  If you're interested, you should explore these later. We want to analyse the data right now!
